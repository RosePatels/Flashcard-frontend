 ...
 <div class="p-(--figma-spacing-250) flex items-center justify-between">
     <div class="flex items-center">
        <div class="relative mr-5">
            <button class="flex cursor-pointer text-preset-4 px-(--figma-spacing-200) py-(--figma-spacing-150) rounded-(--figma-radius-full) border border-(--color-figma-neutral-900) hover:bg-(--color-figma-neutral-100) mr-5" @click="toggleCategoriesDropdown">All Categories
                 <img
...
import CategoriesDropdown from "../allcards/CategoriesDropdown.vue";
